...
public class SJLinkedList<E> implements List<E> {
    ...
    private static class Node<E> {
        ...
        /**
         * "Master" constructor. This is the one that will always be used to construct a new instance
         * @param data the data to be stored in the Node
     ...
     *  <p/>
     *  Time complexity - O(n) - worst case will traverse the entire list and the value is not present
     *
     ...
     *                          last element and assign the last element's next to the new {@code Node}
     *
     ...
     * <p/>
     * Time complexity - O(n) - Like {@code contains(Object o)} it must find the element to remove which
     *                          in the worst case is traversing the entire list and not finding the element
     *
